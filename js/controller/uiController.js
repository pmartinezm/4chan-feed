...
(function(g) {
  app.uiController.refreshBoardLinks = function() {
    ...
    for (var i = 0; i < boards.board.length; i++) {
      ...
      app.uiController.createLinkButton(boards.board[i].id, "header-board-link-cont");
    }
  };

  app.uiController.createLinkButton = function(board, container) {
